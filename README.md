# Date My Family — Production Engineering & Workflow Architecture
## DStv · Mzansi Magic · Channel 161 · Film & TV · Client: Connect TV

![Date My Family Banner](assets/dmf.webp)
...
In this repository, I present the **production technology, systems thinking, and workflow architecture** behind my work on **Date My Family**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: I delivered consistently high-rating broadcast-ready masters for Connect TV across demanding weekly broadcast transmission schedules.
* **CHALLENGE**: I managed extensive unscripted multi-location footage with variable lighting and environmental sound under rigid 48-hour post-production delivery windows.
* **CONTRIBUTION**: I executed digital intermediate colour grading, online editing, graphic overlays, audio conformance, and final technical QC.
* **DELIVERY**: I formatted master deliverables with transmission test signals, precise timing cues, and full broadcast metadata.
...
├── assets/
│   └── dmf.webp                 ← Production visual master
├── diagrams/
